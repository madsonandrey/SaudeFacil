...
public class PlanoSaudeView {
	...
	public void updatePlanoSaude() {
		...
		try {
			...
			System.out.println("Houve um erro ao tentar alterar as informações do plano de saúde");
		}
	}
	...
	public void desabilitaPlanoSaude() {
		...
		scanner = new Scanner(System.in);
		try {
			System.out.println("Indorme o ID do plano para desabilitar o plano de saúde");
			Integer planoId = scanner.nextInt();
			planoSaude.setPlanoId(planoId);
			...
			System.out.println("Houve um erro ao tentar desabilitar o plano de saúde");
		}
	}
