...
public class ProfissionalView extends PessoaView {
	...
	public Profissional criarProfissional() {
		...
		System.out.println("Atende em clínica? Digite 1 para sim e 0 para nÃ£o");
		Integer atendeClinica = leTeclado.nextInt();
		profissional.setAtendeClinica(atendeClinica);
		
		System.out.println("Trabalha como autônomo? Digite 1 para sim e 0 para nÃ£o");
	...
	public void alterarCadastro(){
		...
		if(profissional == null) {
			throw new ProfissionalException("Profissional nÃ£o cadastrado");
		}
